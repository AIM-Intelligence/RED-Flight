...
CREATE OR REPLACE FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer) RETURNS "void"
    ...
    AS $$
BEGIN
  -- Insert into "prompt nft" table
  INSERT INTO public."prompt nft" (creator, prompt, length, conversation, target, level)
  VALUES (p_creator, p_prompt, p_length, p_conversation, p_target, p_level);

  -- Update user score based on level
  IF p_level = 1 THEN
    UPDATE public.user
    SET easy = easy + 1, score = score + 10
    WHERE wallet_address = p_creator;
  ELSIF p_level = 2 THEN
    UPDATE public.user
    SET normal = normal + 1, score = score + 50
    WHERE wallet_address = p_creator;
  ELSIF p_level = 3 THEN
    UPDATE public.user
    SET hard = hard + 1, score = score + 200
    WHERE wallet_address = p_creator;
  ELSIF p_level = 4 THEN
    UPDATE public.user
    SET extreme = extreme + 1, score = score + 600
    WHERE wallet_address = p_creator;
  END IF;
END;
$$;
...
ALTER FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer, "p_name" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
  -- Insert into "prompt nft" table
  INSERT INTO public."red prompt nft" (creator, prompt, length, conversation, target, level, name)
  VALUES (p_creator, p_prompt, p_length, p_conversation, p_target, p_level, p_name);
  ...
  -- Update win count in "blue prompt nft" table
  IF p_name IS NOT NULL THEN
    UPDATE public."blue prompt nft"
    SET win = win + 1
    WHERE name = p_name;
  END IF;
END;
...
ALTER FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer, "p_name" "text") OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."user"
    ADD CONSTRAINT "user_e_pkey" PRIMARY KEY ("id", "wallet_address");



ALTER TABLE ONLY "public"."user"
    ADD CONSTRAINT "user_e_wallet_address_key" UNIQUE ("wallet_address");
...
GRANT ALL ON FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer, "p_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer, "p_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."insert_nft_and_update_score"("p_creator" "text", "p_prompt" "jsonb", "p_length" integer, "p_conversation" integer, "p_target" "text", "p_level" integer, "p_name" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."match_images"("query_embedding" "text", "similarity_threshold" double precision, "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."match_images"("query_embedding" "text", "similarity_threshold" double precision, "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_images"("query_embedding" "text", "similarity_threshold" double precision, "match_count" integer) TO "service_role";
