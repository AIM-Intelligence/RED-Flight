...
CREATE OR REPLACE FUNCTION public.calculate_similarity_and_add_to_score(query_embedding text, target_id uuid, user_wallet text, pixel_similarity numeric, inserteddata_id uuid)
...
BEGIN
  ...
  score_to_add := ROUND(pixel_similarity);
