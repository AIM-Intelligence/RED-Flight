...
// const aurora = defineChain(1313161554);
const auroraT = defineChain(1313161555);
//const kaiaT = defineChain(1001);
//const zkSyncT = defineChain(300);
//const coreT = defineChain(1115);
//const theta = defineChain(365);

export const chainList = [auroraT, sepolia];

export const chain = defineChain(1313161555);
